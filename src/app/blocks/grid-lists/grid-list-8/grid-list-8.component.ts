...
import { integrations } from './grid-list-8.model';
import { MatChip } from '@angular/material/chips';

// Brand icon SVG constants
const GOOGLE_DRIVE_ICON = `
  <svg fill="none" viewBox="0 0 88 78">
...
const SLACK_ICON = `
  <svg fill="none" viewBox="0 0 123 123">
    <path
      fill="#E01E5A"
...
const DROPBOX_ICON = `
  <svg fill="none" viewBox="0 0 165 140">
...
@Component({
  selector: 'ngm-dev-block-grid-list-8',
  templateUrl: './grid-list-8.component.html',
  imports: [MatCardModule, MatIconModule, MatDividerModule, MatChip],
})
export class GridList8Component {
