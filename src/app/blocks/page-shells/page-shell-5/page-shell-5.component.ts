/*
	...
	Update this file using `npx @ngm-dev/cli update page-shells/page-shell-5`
*/
...
@Component({
  selector: 'ngm-dev-block-content-placeholder-shell5',
  template: `
    <div
...
export class ContentPlaceholderShell5Component {
...
@Component({
  selector: 'ngm-dev-block-page-shell-5',
  templateUrl: './page-shell-5.component.html',
  imports: [
    MatCardModule,
    MatExpansionModule,
    MatButtonModule,
    MatIconModule,
    ContentPlaceholderShell5Component,
  ],
})
export class PageShell5Component {
