/*
	...
	Update this file using `npx @ngm-dev/cli update page-shells/page-shell-2`
*/
...
@Component({
  selector: 'ngm-dev-block-content-placeholder-shell2',
  template: `
    <div
...
export class ContentPlaceholderShell2Component {
...
@Component({
  selector: 'ngm-dev-block-page-shell-2',
  templateUrl: './page-shell-2.component.html',
  imports: [
    MatCardModule,
    MatSelectModule,
    MatDividerModule,
    ReactiveFormsModule,
    MatFormFieldModule,
    ContentPlaceholderShell2Component,
  ],
})
export class PageShell2Component {
