/*
	...
	Update this file using `npx @ngm-dev/cli update status-monitoring/status-monitoring-8`
*/
...
@Component({
  selector: 'ngm-dev-block-status-monitoring-8',
  imports: [MatCard, MatCardContent, MatIcon, TrackerComponent],
  templateUrl: './status-monitoring-8.component.html',
})
export class StatusMonitoring8Component {
  private readonly dataBlocks: Array<{ tooltip: string; status: Status }> = [
    ...
    { tooltip: '23 Jan, 2025', status: 'Downtime' },
    ...
    { tooltip: '29 Jan, 2025', status: 'Maintenance' },
    ...
    { tooltip: '5 Feb, 2025', status: 'Not measured' },
    { tooltip: '6 Feb, 2025', status: 'Not measured' },
    { tooltip: '7 Feb, 2025', status: 'Not measured' },
    ...
    { tooltip: '2 Mar, 2025', status: 'Downtime' },
    { tooltip: '3 Mar, 2025', status: 'Downtime' },
    ...
    { tooltip: '1 Apr, 2025', status: 'Downtime' },
    ...
    { tooltip: '7 Apr, 2025', status: 'Downtime' },
  ...
  private readonly dataComponents: Array<{ tooltip: string; status: Status }> =
    [
      { tooltip: '15 Jan, 2025', status: 'Operational' },
      { tooltip: '16 Jan, 2025', status: 'Operational' },
      { tooltip: '17 Jan, 2025', status: 'Operational' },
      ...
      { tooltip: '10 Mar, 2025', status: 'Operational' },
      { tooltip: '11 Mar, 2025', status: 'Operational' },
      { tooltip: '12 Mar, 2025', status: 'Downtime' },
      { tooltip: '13 Mar, 2025', status: 'Operational' },
      { tooltip: '14 Mar, 2025', status: 'Operational' },
      { tooltip: '15 Mar, 2025', status: 'Operational' },
      { tooltip: '16 Mar, 2025', status: 'Operational' },
      ...
      { tooltip: '23 Mar, 2025', status: 'Operational' },
      { tooltip: '24 Mar, 2025', status: 'Operational' },
      { tooltip: '25 Mar, 2025', status: 'Maintenance' },
      { tooltip: '26 Mar, 2025', status: 'Operational' },
      { tooltip: '27 Mar, 2025', status: 'Operational' },
      { tooltip: '28 Mar, 2025', status: 'Operational' },
      { tooltip: '29 Mar, 2025', status: 'Operational' },
  ...
  private mapData(
    data: Array<{ tooltip: string; status: Status }>,
  ): TrackerBlockProps<{ status: Status }>[] {
  ...
  readonly trackerDataBlocks = this.mapData(this.dataBlocks);
  readonly trackerDataBlocksMedium = this.mapData(
    this.dataBlocks.slice(30, 90),
  );
  readonly trackerDataBlocksSmall = this.mapData(this.dataBlocks.slice(60, 90));

  readonly trackerDataComponents = this.mapData(this.dataComponents);
  readonly trackerDataComponentsMedium = this.mapData(
    this.dataComponents.slice(30, 90),
  );
  readonly trackerDataComponentsSmall = this.mapData(
    this.dataComponents.slice(60, 90),
  );
}
