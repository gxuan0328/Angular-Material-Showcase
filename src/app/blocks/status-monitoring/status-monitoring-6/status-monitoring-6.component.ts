/*
	...
	Update this file using `npx @ngm-dev/cli update status-monitoring/status-monitoring-6`
*/
...
@Component({
  selector: 'ngm-dev-block-status-monitoring-6',
  imports: [MatCard, MatCardContent, MatIcon, TrackerComponent],
  templateUrl: './status-monitoring-6.component.html',
})
export class StatusMonitoring6Component {
