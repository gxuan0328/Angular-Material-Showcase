/*
	...
	Update this file using `npx @ngm-dev/cli update status-monitoring/status-monitoring-1`
*/
...
@Component({
  selector: 'ngm-dev-block-status-monitoring-1',
  imports: [MatCard, MatCardContent, MatIcon, TrackerComponent],
  templateUrl: './status-monitoring-1.component.html',
})
export class StatusMonitoring1Component {
