/*
	...
	Update this file using `npx @ngm-dev/cli update status-monitoring/status-monitoring-3`
*/
...
@Component({
  selector: 'ngm-dev-block-status-monitoring-3',
  imports: [MatCard, MatCardContent, TrackerComponent],
  templateUrl: './status-monitoring-3.component.html',
})
export class StatusMonitoring3Component {
  private readonly data: Array<{ tooltip: string; status: Status }> = [
    { tooltip: '15 Jan, 2025', status: 'Inactive' },
    { tooltip: '16 Jan, 2025', status: 'Inactive' },
    { tooltip: '17 Jan, 2025', status: 'Inactive' },
    { tooltip: '18 Jan, 2025', status: 'Inactive' },
    { tooltip: '19 Jan, 2025', status: 'Inactive' },
    { tooltip: '20 Jan, 2025', status: 'Inactive' },
    { tooltip: '21 Jan, 2025', status: 'Inactive' },
    { tooltip: '22 Jan, 2025', status: 'Inactive' },
    { tooltip: '23 Jan, 2025', status: 'Inactive' },
    { tooltip: '24 Jan, 2025', status: 'Inactive' },
    { tooltip: '25 Jan, 2025', status: 'Inactive' },
    { tooltip: '26 Jan, 2025', status: 'Inactive' },
    { tooltip: '27 Jan, 2025', status: 'Inactive' },
    { tooltip: '28 Jan, 2025', status: 'Inactive' },
    { tooltip: '29 Jan, 2025', status: 'Degraded' },
    { tooltip: '30 Jan, 2025', status: 'Degraded' },
    { tooltip: '31 Jan, 2025', status: 'Downtime' },
    { tooltip: '1 Feb, 2025', status: 'Degraded' },
    ...
    { tooltip: '16 Feb, 2025', status: 'Operational' },
    { tooltip: '17 Feb, 2025', status: 'Operational' },
    ...
    { tooltip: '23 Feb, 2025', status: 'Operational' },
    ...
    { tooltip: '19 Mar, 2025', status: 'Operational' },
    ...
    { tooltip: '7 Apr, 2025', status: 'Operational' },
    { tooltip: '8 Apr, 2025', status: 'Operational' },
  ...
  private mapData(data: typeof this.data): TrackerBlockProps[] {
    return data.map((item) => ({
      tooltip: `${item.tooltip}: ${item.status}`,
