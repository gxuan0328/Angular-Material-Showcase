/*
	...
	Update this file using `npx @ngm-dev/cli update status-monitoring/status-monitoring-9`
*/
...
@Component({
  selector: 'ngm-dev-block-status-monitoring-9',
  imports: [MatCard, MatCardContent, MatIcon, TrackerComponent],
  templateUrl: './status-monitoring-9.component.html',
})
export class StatusMonitoring9Component {
  private readonly dataBlocks: Array<{ tooltip: string; status: Status }> = [
    ...
    { tooltip: '18 Jan, 2025', status: 'Downtime' },
    ...
    { tooltip: '8 Feb, 2025', status: 'Not measured' },
    { tooltip: '9 Feb, 2025', status: 'Not measured' },
    ...
    { tooltip: '17 Mar, 2025', status: 'Downtime' },
    { tooltip: '18 Mar, 2025', status: 'Operational' },
    { tooltip: '19 Mar, 2025', status: 'Downtime' },
