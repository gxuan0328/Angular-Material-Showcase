/*
	...
	Update this file using `npx @ngm-dev/cli update status-monitoring/status-monitoring-5`
*/
...
@Component({
  selector: 'ngm-dev-block-status-monitoring-5',
  imports: [
    MatCard,
    MatCardContent,
    MatIcon,
  ...
  templateUrl: './status-monitoring-5.component.html',
})
export class StatusMonitoring5Component {
