/*
	...
	Update this file using `npx @ngm-dev/cli update status-monitoring/status-monitoring-2`
*/
...
@Component({
  selector: 'ngm-dev-block-status-monitoring-2',
  imports: [MatCard, MatCardContent, MatIcon, TrackerComponent, MatButton],
  templateUrl: './status-monitoring-2.component.html',
})
export class StatusMonitoring2Component {
  ...
  private readonly data: Array<{ tooltip: string; status: Status }> = [
    ...
    { tooltip: '16 Jan, 2025', status: 'Downtime' },
    { tooltip: '17 Jan, 2025', status: 'Operational' },
    { tooltip: '18 Jan, 2025', status: 'Operational' },
    ...
    { tooltip: '8 Feb, 2025', status: 'Downtime' },
    ...
    { tooltip: '23 Mar, 2025', status: 'Downtime' },
