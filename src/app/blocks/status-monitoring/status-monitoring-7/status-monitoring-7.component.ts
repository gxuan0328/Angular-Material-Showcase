/*
	...
	Update this file using `npx @ngm-dev/cli update status-monitoring/status-monitoring-7`
*/
...
@Component({
  selector: 'ngm-dev-block-status-monitoring-7',
  imports: [
    MatCard,
    MatCardContent,
    MatIcon,
  ...
  templateUrl: './status-monitoring-7.component.html',
})
export class StatusMonitoring7Component {
  sites = [
    { name: 'site-a.com' },
    { name: 'platform-b.io' },
    { name: 'service-c.dev' },
