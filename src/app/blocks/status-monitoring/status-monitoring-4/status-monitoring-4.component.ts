/*
	...
	Update this file using `npx @ngm-dev/cli update status-monitoring/status-monitoring-4`
*/
...
@Component({
  selector: 'ngm-dev-block-status-monitoring-4',
  imports: [MatCard, MatCardContent, MatIcon, TrackerComponent],
  templateUrl: './status-monitoring-4.component.html',
})
export class StatusMonitoring4Component {
