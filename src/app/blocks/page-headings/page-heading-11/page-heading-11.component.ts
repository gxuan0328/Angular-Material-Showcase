/*
	...
	Update this file using `npx @ngm-dev/cli update page-headings/page-heading-11`
*/
...
@Component({
  selector: 'ngm-dev-block-page-heading-11',
  templateUrl: './page-heading-11.component.html',
  imports: [
    CommonModule,
    MatButtonModule,
    MatIconModule,
...
export class PageHeading11Component {
