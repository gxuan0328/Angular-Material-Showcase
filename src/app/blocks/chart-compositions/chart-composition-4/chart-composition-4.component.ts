/*
	...
	Update this file using `npx @ngm-dev/cli update chart-compositions/chart-composition-4`
*/
...
@Component({
  selector: 'ngm-dev-block-chart-composition-4',
  templateUrl: './chart-composition-4.component.html',
  styleUrls: ['./chart-composition-4.component.scss'],
  imports: [
    BaseChartDirective,
    MatCard,
    MatTab,
...
export class ChartComposition4Component {
