...
@Component({
  selector: 'ngm-dev-block-chart-composition-6',
  templateUrl: './chart-composition-6.component.html',
  styleUrls: ['./chart-composition-6.component.scss'],
  imports: [
    BaseChartDirective,
    MatCard,
    MatTab,
...
export class ChartComposition6Component {
  ...
  topPages: BarListItem[] = [
    ...
    { name: '/docs/visualizations/line-chart', value: 18131 },
    { name: '/docs/visualizations/donut-chart', value: 15107 },
    { name: '/docs/visualizations/spark-charts', value: 13103 },
    { name: '/docs/visualizations/data-bars', value: 9701 },
    { name: '/docs/visualizations/barlist', value: 6502 },
  ];

  topSources: BarListItem[] = [
    { name: 'google.com', value: 12892 },
    { name: 'twitter.com', value: 2070 },
    { name: 'github.com', value: 1296 },
    { name: 'youtube.com', value: 779 },
    { name: 'reddit.com', value: 621 },
    { name: 'linkedin.com', value: 453 },
    { name: 'facebook.com', value: 289 },
    { name: 'stackoverflow.com', value: 234 },
  ];
  ...
  openFullListDialog(title: string, data: BarListItem[]): void {
    this._dialog.open(BarListDialogComponent, {
      width: '400px',
      panelClass: 'dialog-outlined',
      data: { title, data, formatNumber: this.formatNumber },
    });
  }
}
...
// Dialog Component
@Component({
  selector: 'ngm-dev-block-bar-list-dialog',
  template: `
    ...
    <mat-dialog-content>
      <div class="mt-6">
        <ngm-dev-block-ui-bar-list
          ...
          [valueFormatter]="dialogData.formatNumber"
          [sortOrder]="'descending'"
        />
      </div>
    </mat-dialog-content>
  `,
  imports: [MatDivider, BarListComponent, MatDialogContent, MatDialogTitle],
})
export class BarListDialogComponent {
  dialogData = inject<{
    title: string;
    data: BarListItem[];
