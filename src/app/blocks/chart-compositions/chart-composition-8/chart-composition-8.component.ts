/*
	...
	Update this file using `npx @ngm-dev/cli update chart-compositions/chart-composition-8`
*/
...
@Component({
  selector: 'ngm-dev-block-chart-composition-8',
  templateUrl: './chart-composition-8.component.html',
  imports: [BaseChartDirective, MatChip, MatDivider],
})
export class ChartComposition8Component {
