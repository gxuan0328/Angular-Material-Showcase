/*
	...
	Update this file using `npx @ngm-dev/cli update chart-compositions/chart-composition-10`
*/
...
@Component({
  selector: 'ngm-dev-block-chart-composition-10',
  templateUrl: './chart-composition-10.component.html',
  imports: [
    BaseChartDirective,
    MatChip,
    MatDivider,
...
export class ChartComposition10Component {
