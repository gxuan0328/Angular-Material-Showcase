/*
	...
	Update this file using `npx @ngm-dev/cli update stacked-layouts/nav-with-bottom-border`
*/
...
@Component({
  selector: 'ngm-dev-block-content-placeholder-nav-with-bottom-border',
  template: `
    <div
...
export class ContentPlaceholderNavWithBottomBorderComponent {
  readonly patternId = input('nav-with-bottom-border-pattern-1');
}

@Component({
  selector: 'ngm-dev-block-nav-with-bottom-border',
  templateUrl: './nav-with-bottom-border.component.html',
  imports: [
    MatToolbarModule,
    MatButtonModule,
    MatIconModule,
    ...
    MatSidenavModule,
    AsyncPipe,
    ContentPlaceholderNavWithBottomBorderComponent,
    MatListModule,
    RouterLink,
  ],
})
export class NavWithBottomBorderComponent {
