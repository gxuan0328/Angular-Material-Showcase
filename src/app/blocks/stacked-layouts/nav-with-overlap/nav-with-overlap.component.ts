/*
	...
	Update this file using `npx @ngm-dev/cli update stacked-layouts/nav-with-overlap`
*/
...
@Component({
  selector: 'ngm-dev-block-content-placeholder-nav-with-overlap',
  template: `
    <div
...
export class ContentPlaceholderNavWithOverlapComponent {
  readonly patternId = input('nav-with-overlap-pattern-1');
}

@Component({
  selector: 'ngm-dev-block-nav-with-overlap',
  templateUrl: './nav-with-overlap.component.html',
  imports: [
    MatToolbarModule,
    MatButtonModule,
    MatIconModule,
    ...
    MatSidenavModule,
    AsyncPipe,
    ContentPlaceholderNavWithOverlapComponent,
    MatListModule,
    RouterLink,
  ],
})
export class NavWithOverlapComponent {
