/*
	...
	Update this file using `npx @ngm-dev/cli update stacked-layouts/nav-on-gray-background`
*/
...
@Component({
  selector: 'ngm-dev-block-content-placeholder-nav-on-gray-background',
  template: `
    <div
...
export class ContentPlaceholderNavOnGrayBackgroundComponent {
  readonly patternId = input('nav-on-gray-background-pattern-1');
}

@Component({
  selector: 'ngm-dev-block-nav-on-gray-background',
  templateUrl: './nav-on-gray-background.component.html',
  imports: [
    MatToolbarModule,
    MatButtonModule,
    MatIconModule,
    ...
    MatSidenavModule,
    AsyncPipe,
    ContentPlaceholderNavOnGrayBackgroundComponent,
    MatListModule,
    RouterLink,
  ],
})
export class NavOnGrayBackgroundComponent {
