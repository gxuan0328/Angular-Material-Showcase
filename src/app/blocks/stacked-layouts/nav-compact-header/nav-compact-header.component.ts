/*
	...
	Update this file using `npx @ngm-dev/cli update stacked-layouts/nav-compact-header`
*/
...
@Component({
  selector: 'ngm-dev-block-content-placeholder-nav-compact-header',
  template: `
    <div
...
export class ContentPlaceholderNavCompactHeaderComponent {
  readonly patternId = input('nav-compact-header-pattern-1');
}

@Component({
  selector: 'ngm-dev-block-nav-compact-header',
  templateUrl: './nav-compact-header.component.html',
  imports: [
    MatToolbarModule,
    MatButtonModule,
    MatIconModule,
    ...
    MatSidenavModule,
    AsyncPipe,
    ContentPlaceholderNavCompactHeaderComponent,
    MatListModule,
    RouterLink,
  ],
})
export class NavCompactHeaderComponent {
