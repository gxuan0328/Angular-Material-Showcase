...
@Component({
  selector: 'ngm-dev-block-content-placeholder-two-row-nav-overlap',
  template: `
    <div
...
export class ContentPlaceholderTwoRowNavOverlapComponent {
  readonly patternId = input('two-row-nav-overlap-pattern-1');
}

@Component({
  selector: 'ngm-dev-block-two-row-nav-overlap',
  templateUrl: './two-row-nav-overlap.component.html',
  imports: [
    MatToolbarModule,
    MatButtonModule,
    MatIconModule,
    ...
    MatSidenavModule,
    AsyncPipe,
    ContentPlaceholderTwoRowNavOverlapComponent,
    MatListModule,
    RouterLink,
    MatFormFieldModule,
    MatInputModule,
...
export class TwoRowNavOverlapComponent {
