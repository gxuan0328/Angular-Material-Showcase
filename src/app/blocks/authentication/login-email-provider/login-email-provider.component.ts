/*
	...
	Update this file using `npx @ngm-dev/cli update authentication/login-email-provider`
*/
...
const TWITTER_ICON = `<svg width="1200" height="1227" viewBox="0 0 1200 1227" fill="none" xmlns="http://www.w3.org/2000/svg">
...
@Component({
  selector: 'ngm-dev-block-login-email-provider',
  templateUrl: './login-email-provider.component.html',
  imports: [
    MatCard,
    MatCardContent,
    MatCardActions,
...
export class LoginEmailProviderComponent {
  form = new FormGroup({
  ...
  constructor() {
    ...
    this.matIconRegistry.addSvgIconLiteral(
      'twitter',
      this.sanitizer.bypassSecurityTrustHtml(TWITTER_ICON),
    );
    this.matIconRegistry.addSvgIconLiteral(
      'github',
