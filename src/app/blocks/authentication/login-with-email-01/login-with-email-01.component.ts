/*
	...
	Update this file using `npx @ngm-dev/cli update authentication/login-with-email-01`
*/
...
@Component({
  selector: 'ngm-dev-block-login-with-email-01',
  templateUrl: './login-with-email-01.component.html',
...
export class LoginWithEmail01Component {
  form = new FormGroup({
