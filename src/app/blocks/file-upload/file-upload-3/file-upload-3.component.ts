/*
	...
	Update this file using `npx @ngm-dev/cli update file-upload/file-upload-3`
*/
...
@Component({
  selector: 'ngm-dev-block-file-upload3-dropzone',
  imports: [MatIcon],
...
export class FileUpload3DropzoneComponent extends DropzoneComponent {
  @HostListener('click')
  onClick() {
    this.openFilePicker();
  }
...
@Component({
  selector: 'ngm-dev-block-file-upload-3',
  templateUrl: './file-upload-3.component.html',
  imports: [
    MatButtonModule,
    MatIconModule,
    MatInputModule,
