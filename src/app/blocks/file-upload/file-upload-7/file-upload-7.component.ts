/*
	...
	Update this file using `npx @ngm-dev/cli update file-upload/file-upload-7`
*/
...
@Component({
  selector: 'ngm-dev-block-file-upload7-dropzone',
  imports: [MatIcon],
...
export class FileUpload7DropzoneComponent extends DropzoneComponent {
  @HostListener('click')
  onClick() {
    this.openFilePicker();
  }
...
@Component({
  selector: 'ngm-dev-block-file-upload-7',
  templateUrl: './file-upload-7.component.html',
  imports: [
    MatButtonModule,
    MatIconModule,
    MatInputModule,
    ...
    ReactiveFormsModule,
    FileInputDirective,
    FileUpload7DropzoneComponent,
    MatProgressBarModule,
  ],
})
export class FileUpload7Component {
