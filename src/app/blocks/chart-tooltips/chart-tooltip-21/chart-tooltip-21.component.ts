/*
	...
	Update this file using `npx @ngm-dev/cli update chart-tooltips/chart-tooltip-21`
*/
...
@Component({
  selector: 'ngm-dev-block-chart-tooltip-21',
  templateUrl: './chart-tooltip-21.component.html',
  imports: [BaseChartDirective, MatDivider, MatButton],
})
export class ChartTooltip21Component {
