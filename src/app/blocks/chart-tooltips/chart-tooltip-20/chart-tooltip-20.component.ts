/*
	...
	Update this file using `npx @ngm-dev/cli update chart-tooltips/chart-tooltip-20`
*/
...
@Component({
  selector: 'ngm-dev-block-chart-tooltip-20',
  templateUrl: './chart-tooltip-20.component.html',
  imports: [
    BaseChartDirective,
    MatList,
    MatListItem,
...
export class ChartTooltip20Component {
