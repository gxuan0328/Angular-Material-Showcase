/*
	...
	Update this file using `npx @ngm-dev/cli update chart-tooltips/chart-tooltip-4`
*/
...
@Component({
  selector: 'ngm-dev-block-chart-tooltip-4',
  templateUrl: './chart-tooltip-4.component.html',
  imports: [BaseChartDirective, MatDivider, MatButton],
})
export class ChartTooltip4Component {
  ...
  chartData: ChartData<'bar', number[], string> = {
    ...
    datasets: [
      {
        data: this.labels.map(() => this.rand(10, 100)),
        label: 'completed',
