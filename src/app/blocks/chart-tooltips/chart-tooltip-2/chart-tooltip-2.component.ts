/*
	...
	Update this file using `npx @ngm-dev/cli update chart-tooltips/chart-tooltip-2`
*/
...
@Component({
  selector: 'ngm-dev-block-chart-tooltip-2',
  templateUrl: './chart-tooltip-2.component.html',
  imports: [BaseChartDirective, MatButton],
})
export class ChartTooltip2Component {
  ...
  chartData: ChartData<'bar', number[], string> = {
    ...
    datasets: [
      {
        data: this.generateSeries(this.labels.length, 110, 220),
        label: 'Running',
