/*
	...
	Update this file using `npx @ngm-dev/cli update chart-tooltips/chart-tooltip-15`
*/
...
@Component({
  selector: 'ngm-dev-block-chart-tooltip-15',
  templateUrl: './chart-tooltip-15.component.html',
  imports: [BaseChartDirective, MatButton],
})
export class ChartTooltip15Component {
