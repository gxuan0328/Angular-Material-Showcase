/*
	...
	Update this file using `npx @ngm-dev/cli update chart-tooltips/chart-tooltip-11`
*/
...
@Component({
  selector: 'ngm-dev-block-chart-tooltip-11',
  templateUrl: './chart-tooltip-11.component.html',
  imports: [BaseChartDirective, MatButton],
})
export class ChartTooltip11Component {
