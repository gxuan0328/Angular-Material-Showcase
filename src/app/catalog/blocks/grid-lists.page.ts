...
const VARIANTS: readonly BlockVariant[] = [
  {
    id: 'grid-list-1',
    label: 'Grid List 01 — 基本圖片網格（Free）',
    registryCategory: 'free-grid-lists',
    component: GridList1Component,
    isFree: true,
  },
  {
    id: 'grid-list-2',
    label: 'Grid List 02 — 含標題與描述',
    registryCategory: 'grid-lists',
    component: GridList2Component,
    isFree: false,
  },
  {
    id: 'grid-list-3',
    label: 'Grid List 03 — 卡片式網格',
    registryCategory: 'grid-lists',
    component: GridList3Component,
    isFree: false,
  },
  {
    id: 'grid-list-4',
    label: 'Grid List 04 — 人物頭像網格',
    registryCategory: 'grid-lists',
    component: GridList4Component,
    isFree: false,
  },
  {
    id: 'grid-list-5',
    label: 'Grid List 05 — 作品集網格',
    registryCategory: 'grid-lists',
    component: GridList5Component,
    isFree: false,
  },
  {
    id: 'grid-list-6',
    label: 'Grid List 06 — 產品目錄網格',
    registryCategory: 'grid-lists',
    component: GridList6Component,
    isFree: false,
  },
  {
    id: 'grid-list-7',
    label: 'Grid List 07 — 含 overlay 的圖片網格',
    registryCategory: 'grid-lists',
    component: GridList7Component,
    isFree: false,
  },
  {
    id: 'grid-list-8',
    label: 'Grid List 08 — 含標籤的卡片網格',
    registryCategory: 'grid-lists',
    component: GridList8Component,
    isFree: false,
  },
  {
    id: 'grid-list-9',
    label: 'Grid List 09 — 整合整合清單',
    registryCategory: 'grid-lists',
    component: GridList9Component,
    isFree: false,
  },
  {
    id: 'grid-list-10',
    label: 'Grid List 10 — 檔案管理網格',
    registryCategory: 'grid-lists',
    component: GridList10Component,
    isFree: false,
  },
  {
    id: 'grid-list-11',
    label: 'Grid List 11 — 媒體庫網格',
    registryCategory: 'grid-lists',
    component: GridList11Component,
    isFree: false,
  },
  {
    id: 'grid-list-12',
    label: 'Grid List 12 — 含動作按鈕的網格',
    registryCategory: 'grid-lists',
    component: GridList12Component,
    isFree: false,
  },
  {
    id: 'grid-list-13',
    label: 'Grid List 13 — 緊湊網格',
    registryCategory: 'grid-lists',
    component: GridList13Component,
    isFree: false,
  },
  {
    id: 'grid-list-14',
    label: 'Grid List 14 — 含狀態指示器',
    registryCategory: 'grid-lists',
    component: GridList14Component,
    isFree: false,
  },
  {
    id: 'grid-list-15',
    label: 'Grid List 15 — 混合尺寸網格',
    registryCategory: 'grid-lists',
    component: GridList15Component,
    isFree: false,
  },
];
