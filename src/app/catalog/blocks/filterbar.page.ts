...
const VARIANTS: readonly BlockVariant[] = [
  { id: 'filterbar-1', label: 'Filter Bar 01 — 基本篩選列', registryCategory: 'filterbar', component: Filterbar1Component, isFree: false },
  { id: 'filterbar-2', label: 'Filter Bar 02 — 多條件搜尋篩選', registryCategory: 'filterbar', component: Filterbar2Component, isFree: false },
  { id: 'filterbar-3', label: 'Filter Bar 03 — 日期區間篩選', registryCategory: 'filterbar', component: Filterbar3Component, isFree: false },
  { id: 'filterbar-4', label: 'Filter Bar 04 — Chip 標籤篩選', registryCategory: 'filterbar', component: Filterbar4Component, isFree: false },
  { id: 'filterbar-5', label: 'Filter Bar 05 — 側邊抽屜篩選', registryCategory: 'filterbar', component: Filterbar5Component, isFree: false },
  { id: 'filterbar-6', label: 'Filter Bar 06 — 含進階搜尋', registryCategory: 'filterbar', component: Filterbar6Component, isFree: false },
  { id: 'filterbar-7', label: 'Filter Bar 07 — 含快速操作', registryCategory: 'filterbar', component: Filterbar7Component, isFree: false },
  { id: 'filterbar-8', label: 'Filter Bar 08 — 緊湊篩選列', registryCategory: 'filterbar', component: Filterbar8Component, isFree: false },
  { id: 'filterbar-9', label: 'Filter Bar 09 — 含儲存條件', registryCategory: 'filterbar', component: Filterbar9Component, isFree: false },
  { id: 'filterbar-10', label: 'Filter Bar 10 — 多選下拉篩選', registryCategory: 'filterbar', component: Filterbar10Component, isFree: false },
  { id: 'filterbar-11', label: 'Filter Bar 11 — 含分類標籤', registryCategory: 'filterbar', component: Filterbar11Component, isFree: false },
  { id: 'filterbar-12', label: 'Filter Bar 12 — 全能型篩選列', registryCategory: 'filterbar', component: Filterbar12Component, isFree: false },
];
