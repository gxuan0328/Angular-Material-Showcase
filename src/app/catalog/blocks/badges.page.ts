...
const VARIANTS: readonly BlockVariant[] = [
  { id: 'badge-1', label: 'Badge 01 — 基本狀態徽章（Free）', registryCategory: 'free-badges', component: Badge1Component, isFree: true },
  { id: 'badge-2', label: 'Badge 02 — 含點狀指示器', registryCategory: 'badges', component: Badge2Component, isFree: false },
  { id: 'badge-3', label: 'Badge 03 — 含圖示徽章', registryCategory: 'badges', component: Badge3Component, isFree: false },
  { id: 'badge-4', label: 'Badge 04 — 圓形徽章', registryCategory: 'badges', component: Badge4Component, isFree: false },
  { id: 'badge-5', label: 'Badge 05 — 邊框徽章', registryCategory: 'badges', component: Badge5Component, isFree: false },
  { id: 'badge-6', label: 'Badge 06 — 大尺寸徽章', registryCategory: 'badges', component: Badge6Component, isFree: false },
  { id: 'badge-7', label: 'Badge 07 — 含關閉按鈕', registryCategory: 'badges', component: Badge7Component, isFree: false },
  { id: 'badge-8', label: 'Badge 08 — 多色狀態組', registryCategory: 'badges', component: Badge8Component, isFree: false },
  { id: 'badge-9', label: 'Badge 09 — 漸層徽章', registryCategory: 'badges', component: Badge9Component, isFree: false },
  { id: 'badge-10', label: 'Badge 10 — 軟色調徽章', registryCategory: 'badges', component: Badge10Component, isFree: false },
  { id: 'badge-11', label: 'Badge 11 — 實色強調徽章', registryCategory: 'badges', component: Badge11Component, isFree: false },
  { id: 'badge-12', label: 'Badge 12 — 含計數徽章', registryCategory: 'badges', component: Badge12Component, isFree: false },
];
...
const META: CatalogBlockMeta = {
  ...
  summary:
    '徽章與標籤集合，用於標示狀態、計數、分類與重要性提示，提供多種顏色、尺寸與樣式變體。',
